...
app.js dosyasının ES modülü olarak çalışmasını sağlamak için package.json dosyasına "type": "module" eklemeniz gerekiyor.

* package.json dosyanızı açın.
* "type": "module" ifadesini ana düzeydeki objeye ekleyin. Böylece tüm dosyalar ES modülleri olarak işlenecektir.
